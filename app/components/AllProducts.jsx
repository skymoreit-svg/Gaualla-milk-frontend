            ...
            <div className="flex  lg:gap-x-8">
              ...
              <div className="lg:w-[75%]">
                ...
                <div className="flex justify-center gap-x-4 mt-4 lg:mt-6">
                  <button onClick={() => handlePrev()} className="px-4 py-2 bg-black text-white rounded-lg hover:bg-text hover:-translate-y-1 transition">
                    Prev
                  </button>

                  <button className="px-4 py-2 bg-black text-white rounded-lg hover:bg-text hover:-translate-y-1 transition">
                    {currentPage}
                  </button>

                  <button onClick={() => handleNext()} className="px-4 py-2 bg-black text-white rounded-lg hover:bg-text hover:-translate-y-1 transition">
                    Next
                  </button>
