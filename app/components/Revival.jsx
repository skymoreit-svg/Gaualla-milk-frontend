                    ...
                    <div className="w-full lg:w-[50%] space-y-5">
                        <div className="flex justify-center lg:justify-start items-center gap-x-2">
                            {Array.from({ length: 3 }, (_, i) => (
                                <div key={i} className="rounded-full h-2 w-2 border border-[var(--primary)]"></div>
                            ))}
                            <span className="uppercase text-[var(--primary)]">
                        ...
                        <Link
                            ...
                            className="flex mx-auto lg:mx-0 group items-center gap-x-2 px-5 py-2 lg:px-8 bg-[var(--primary)] text-white font-bold rounded-3xl w-fit"
                        >
                            Order Now
